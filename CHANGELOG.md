...
### Added
- Social login authentication with Google and GitHub OAuth, enabling seamless user sign up and log in with automatic account linking for existing password accounts (#537).
