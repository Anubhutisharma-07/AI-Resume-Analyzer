export type LighthouseMetricType = 'PERFORMANCE' | 'ACCESSIBILITY' | 'BEST_PRACTICES' | 'SEO' | 'PWA';
...
export interface LighthouseAuditTimelineLog {
  logId: string;
  timestamp: string;
  eventType: 'AUDIT_RUN_COMPLETED' | 'ACCESSIBILITY_FIX_APPLIED' | 'SEO_TAG_INJECTED' | 'LIGHTHOUSE_CI_VERIFIED';
  details: string;
  performer: string;
