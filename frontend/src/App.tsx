          ...
          >
            ...
            >
              ...
              {isDraftSaved && (
                <Link
                  to="/career-path"
                  className={`flex flex-col items-center p-2 rounded-xl transition-all duration-300 ${isActive('/career-path')
                      ? 'text-teal-500 bg-teal-50'
                      : 'text-slate-600 hover:text-teal-600 hover:bg-slate-50'
                    }`}
                >
                  <Map className="mb-1" size={24} />
                  <span className="text-[10px] font-semibold text-center leading-tight">Career Path</span>
                </Link>
              )}
              {isDraftSaved && (
                <span
